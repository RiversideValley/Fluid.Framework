...
<!--
@component
Checkboxes represent a control that a user can select (check) or clear (uncheck). A Checkbox can also report its value as indeterminate. [Docs](https://fluidui.vercel.app/docs/components/checkbox)
- Usage:
    ```tsx
